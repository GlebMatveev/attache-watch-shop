...
<template>
  <section class="minimalTop">
    <div class="container">
      <div class="minimalTop__name">
        <h1 class="minimalTop__heading">ПОЛИТИКА КОНФИДЕНЦИАЛЬНОСТИ</h1>
  ...
  <article class="policy">
    <div class="container">
      <p>Обновлено «04» декабря 2021 г.</p>
      <p>
        Политика конфиденциальности объясняет пользователям ресурса
        (сайт/мобильное приложение), с какой целью их личная информация
        собирается, и как будет использоваться. Политика конфиденциальности
        ресурса (сайт/мобильное приложение) должна предоставлять пользователям
        следующие гарантии:
      </p>
      <p></p>
      <ul>
        ...
        <li>
          использование сведений, предоставленных пользователем, исключительно с
          целью связи с ним, в том числе для направления электронных уведомлений
        </li>
      </ul>
      <p>
        Основное условие политики конфиденциальности ресурса (сайт/мобильное
        приложение) — максимальная прозрачность. После её прочтения пользователь
        должен получить полное представление о том, с какой целью от него
        требуется предоставление личных данных, как они хранятся,
        обрабатываются, каким образом защищены и т.д.
      </p>
      <p>
        Пользовательское соглашение — это соглашение пользователей ресурса
        (сайт/мобильное приложение) с одной стороны и ресурсом (сайт/мобильное
        приложение) с другой стороны, в котором прописаны ряд условий между
        сторонами.
      </p>
      <p>
        Пользовательское соглашение регламентирует отношения между
        пользователями и ресурсом (сайт/мобильное приложение).
      </p>
      <p>
        Пользовательское соглашение определяет юридическую, правовую сторону
        деятельности в интернете. Это публичная оферта, присоединяясь к которой
        посетитель сайта получает права и обязанности, определённые владельцем
        ресурса (сайт/мобильное приложение).
      </p>

      <h2>1. ОБЩИЕ ПОЛОЖЕНИЯ</h2>
      <p>
        1.1. Настоящее Пользовательское соглашение (далее — Соглашение)
        относится к сайту <b>attache.com</b>, расположенному по адресу
        <a href="https://attache.com/policy">https://attache.com/policy</a>, и
        ко всем соответствующим сайтам, связанным с сайтом <b>attache.com</b>.
      </p>
      <p>
        1.2. Сайт <b>attache.com</b> (далее — Сайт) является собственностью
        ATTACHE
      </p>
      <p>
        1.3. Настоящее Соглашение регулирует отношения между Администрацией
        сайта <b>attache.com</b> (далее — Администрация сайта) и Пользователем
        данного Сайта.
      </p>
      <p>
      ...
      <p>
        2.1.1 Сайт, расположенный на доменном имени <b>attache.com</b>,
        осуществляющий свою деятельность посредством Интернет-ресурса и
        сопутствующих ему сервисов.
      </p>
      <p>
        2.1.2. Сайт, содержащий информацию о Товарах, Продавце, позволяющий
        осуществить выбор и заказ Товара.
      </p>
      <p>
        2.1.3. Администрация Сайта — уполномоченные сотрудники на управления
        Сайтом, действующие от имени ATTACHE.
      </p>
      <p>
      ...
      <p>
        ...
        Пользователю Сайта доступа к содержащимся на Сайте Товарам и оказываемым
        услугам.
      </p>
      <p>
      ...
      <ul>
        <li>
          ...
          приобретения, просмотра контента
        </li>
        <li>доступ к средствам поиска и навигации Сайта</li>
        <li>
          предоставление Пользователю возможности размещения сообщений,
          комментариев, рецензий Пользователей, выставления оценок контенту
          Сайта
        </li>
        <li>
          доступ к информации о Товаре и к информации о приобретении Товара на
          бесплатной основе
        </li>
      ...
      <p>3.2. Доступ к Сайту предоставляется на безвозмездной основе.</p>
      <p>
      ...
      <p>
        4.2.1. Получить доступ к использованию Сайта после соблюдения требований
        о регистрации.
      </p>
      <p>
      ...
      <p>
        4.2.3. Задавать любые вопросы, относящиеся к услугам Сайта по
      ...
      <p>
        4.3.7. 2. побуждения к совершению противоправных действий, а также
      ...
      <p>
        4.3.7. 3. нарушения прав несовершеннолетних лиц и (или) причинение им
        вреда в любой форме.
      </p>
      ...
      <p>
        ...
        какого-либо Товара из каталога Сайта, размещенного на Сайте.
      </p>
      <p>
        4.3.7. 7. некорректного сравнения Товара, а также формирования
        негативного отношения к лицам, (не) пользующимся определенными Товарами,
        или осуждения таких лиц.
      </p>
      ...
      <p>
        ...
        более 36 календарных месяцев подряд без уведомления Пользователя.
      </p>
      <p>
        5.7. Настоящее Соглашение распространяет свое действия на все
        дополнительные положения и условия о покупке Товара и оказанию услуг,
      ...
      <p>
        ...
        на Сайте, и (или) в цены, применимые к таким Товарам по их реализации и
        (или) оказываемым услугам Сайта.
      </p>
      <p>
        5.10. Документы, указанные в пунктах 5.10.1 — 5.10.4 настоящего
        Соглашения регулируют в соответствующей части и распространяют свое
        действие на использование Пользователем Сайта. В настоящее Соглашение
      ...
      <p>
        7.5. Администрация сайта не несет ответственности перед Пользователем
      ...
      <p>
        ...
        предъявлен в течение 10 после возникновения оснований для иска, за
